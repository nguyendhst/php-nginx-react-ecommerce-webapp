...
const EditPost = () => {
    ...
    const handleSubmit = (event) => {
        ...
        if(isValid === 1){
            axios.put(`http://localhost:80/api/post/${id}/edit`, inputs).then(function(response){
                navigate('/managepost');
    ...
    return(
        <div className="Wrap" style={{margin: "50px 20px 0px 20px"}}>
            <style>{css}</style>
            <h1 style={{textAlign: "center", borderBottom: "2px solid black", paddingBottom: "10px"}}>ADD/EDIT POST</h1>
            ...
            <div className="mb-3">
                ...
                <input value={inputs.title} type="text" className="form-control" id="name" name="title" onChange={handleChange}/>
            ...
            <div className="mb-3">
                ...
                <input value={inputs.description} type="text" className="form-control" name="description" onChange={handleChange}/>
